...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    spectacles: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSpectacleSpectacle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audience: Schema.Attribute.Enumeration<
      ['tout_public', 'famille', 'adultes', 'interdit_moins_16']
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultWeezeventIframeSrc: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    heroBanner: Schema.Attribute.Media<'images'>;
    journees: Schema.Attribute.Component<'spectacle.journee', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::spectacle.spectacle'
    > &
      Schema.Attribute.Private;
    priceXPF: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    salle: Schema.Attribute.Enumeration<
      [
        'Grand th\u00E9\u00E2tre de la Maison de la Culture (Papeete)',
        'Petit th\u00E9\u00E2tre de la Maison de la Culture (Papeete)',
        'Hotel Le TAHITI',
